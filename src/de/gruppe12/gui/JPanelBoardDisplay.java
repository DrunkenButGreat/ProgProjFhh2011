...
public class JPanelBoardDisplay extends JPanel {
	 ...
	 * JPanelBoardDisplay
	 * 
	 * Konstruktor, der die Ressourcen lädt, den GuiController speichert und anschließend ein repaint aufruft
	 * 
	 ...
	 * drawStone
	 * 
	 * zeichnet Spielfigur an der Zelle xy (Icon hängt vom BoardContent ab)
	 * 
